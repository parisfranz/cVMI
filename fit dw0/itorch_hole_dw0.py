...
from torchrecon_funcs_cal_dw0 import *
import os

# #######
Ups = [int(sys.argv[1])]# [float(sys.argv[1])]
eshift = 0 #1 #0 # 3.9/4.8*3 #6/4.02 #0 #4/4.9*3 #0 #opposite sign of dw
...
# specdatname = '/cds/home/p/paris/reconVMI_clean/recon X510 Dec/specs_Jun15_unstreaked.npy'
# mdatname = '/cds/home/p/paris/reconVMI_clean/recon X510 Dec/Ms_Jun15_unstreaked.npy'
specdatname = '/cds/home/p/paris/reconVMI_clean/recon X510 Dec/specs_Jul5_unstreaked127.npy'
mdatname = '/cds/home/p/paris/reconVMI_clean/recon X510 Dec/Ms_Jul5_unstreaked127.npy'
...
#for k in np.arange(169,204):
    for t in range(5):
        tt = np.copy(t)
        savefilename = '/reg/d/psdm/tmo/tmox51020/results/paris/recon/torch_Jul5_unstreaked_dw0/pytorchrecon_'+str(k)+'_Up'+str(Ups[0])+'_seed'+str(tt)+'.npy'
...
#             spec_in = f(xs)
         ...
         #####
            ...
            for epoch in range(int(n_epochs)):
                ...
                ll=loss_func(M,Q,Nb,Bpr,Bpi,spec_in, alphaw_r, alphaw_i,M_wght,Spec_wght,Smooth_wght,thresh)
                loss_func(M,Q,Nb,Bpr,Bpi,spec_in, alphaw_r, alphaw_i,M_wght,Spec_wght,Smooth_wght,thresh).backward()
                ...
                if epoch%100==0:
                    ...
                    costW.append(loss_w_w0(spec_in, Q, alphaw_r, alphaw_i, Nb).detach().numpy()[()]*Spec_wght)
