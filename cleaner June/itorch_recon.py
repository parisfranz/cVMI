...
from torch_recon_funcs import *
import os

# #######
Ups = [float(sys.argv[1])]
eshift = 2 #1 #0 # 3.9/4.8*3 #6/4.02 #0 #4/4.9*3 #0 #opposite sign of dw
...
#for k in np.arange(169,204):
    for t in range(5):
        tt = np.copy(t)
        savefilename = '/reg/d/psdm/tmo/tmox51020/results/paris/recon/torch_May31_127/pytorchrecon_'+str(k)+'_Up'+str(Ups[0])+'_seed'+str(tt)+'.npy'
